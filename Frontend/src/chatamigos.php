                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Chat Amigos</h3></div>
                                    <div class="card-body">
                                    <div float="left">
                                        <form method="post" action="chatreq.php" >
                                        <label for="cars">Selecciona uno de tus Amigos para chatear:</label><br>
