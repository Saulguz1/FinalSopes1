...
<meta http-equiv="refresh" content="10;url=chatactualizar.php" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <label style="color:blue;font-size:50px;"><?php echo $datos['user']; ?></label><br>
                                    <label style="color:green;font-size:10px;">En linea</label>                                    
                                </div>
                                    <div class="card-body">
                                                ...
                                                <form method="post" action="chatactualizar.php" enctype="multipart/form-data">
                                                    <div class="form-group">
